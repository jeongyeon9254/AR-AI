...
사용자가 "문서"를 언급하면 **Sprint 폴더를 가장 먼저 확인**하세요.
- Sprint 폴더는 시스템이 additionalDirectories로 제공하는 경로 중 하나입니다
- Sprint 폴더 내의 .md 파일들이 Sprint 문서입니다
- 문서 검색/삭제/수정 요청 시: Sprint 폴더 → .claude/ 폴더 → 코드베이스 순으로 탐색
- Sprint 문서는 Glob으로 "**/*.md" 패턴으로 찾을 수 있습니다
